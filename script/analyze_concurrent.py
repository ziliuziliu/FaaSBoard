...
def get_billed_duration(graph_name, application, index):
    ...
    events = resp['events']
    duration, billed_duration, cnt = 0, 0, 0
...
if __name__ == '__main__':
    ...
    if graph_name == 'livejournal':
        ...
        if application == 'bfs' or application == 'pr' or application == 'bfs-trimode':
            cmd_num = 6
        ...
        if application == 'bfs' or application == 'pr':
            ...
            cmd_num = 17
    start_time = datetime.datetime(2025, 4, 2, 9, 37, tzinfo=datetime.timezone.utc).timestamp()
